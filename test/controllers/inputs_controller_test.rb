...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference("Input.count") do
      post inputs_url, params: { input: { form_id: @input.form_id, inputable_id: @input.inputable_id, inputable_type: @input.inputable_type, position: @input.position } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { form_id: @input.form_id, inputable_id: @input.inputable_id, inputable_type: @input.inputable_type, position: @input.position } }
